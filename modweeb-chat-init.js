...
document.addEventListener("DOMContentLoaded", function() {
    ...
    cssLink.href = "https://cdn.jsdelivr.net/gh/modweeb-widget/chat-ai-gama@main/modweeb-chat.css"; // تأكد من 'main' أو الفرع الافتراضي لمستودعك
    document.head.appendChild(cssLink);

    // تحميل ملف JavaScript الرئيسي
    const chatScript = document.createElement("script");
    chatScript.src = "https://cdn.jsdelivr.net/gh/modweeb-widget/chat-ai-gama@main/modweeb-chat.js"; // تأكد من 'main' أو الفرع الافتراضي لمستودعك
